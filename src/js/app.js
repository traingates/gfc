...
(function () {
  ...
  const money = (n) => `${Number(n || 0).toFixed(2)} ${esc((D.commerce && D.commerce.currency) || "DC$")}`;
  ...
  function settingsEditorHTML() {
    ...
    return `
      <div class="admin-panel">
        ...
        ${fieldHTML({ label:"Currency label", type:"text", hint:"Display-only, e.g. DC$, USD, EUR." }, d.commerce.currency, "commerce.currency")}
